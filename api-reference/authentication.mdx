...
<Note>
  **Contact Sales for API Access** - To obtain your API authorization token, please contact our sales team at [sales@rulebook.company](mailto:sales@rulebook.company) or through our [website](https://rulebookcompany.com/contact).
</Note>
